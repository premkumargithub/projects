module.exports = {
    ...
    db: 'mongodb://172.16.223.60/global-rockstar',
    upload: process.env['UPLOAD'] || 'http://localhost:3043',
    agenda: {
        db: 'mongodb://172.16.223.60/global-rockstar-agenda',
        collection: 'agenda'
    },
    ...
    frontendUrl: 'https://devweb.globalrockstar.com',
    facebook: {
        artistUrl: 'https://devfacebook-artist.globalrockstar.com',
        arenaUrl: 'https://devfacebook-arena.globalrockstar.com'
    },
    payPal_sandbox: {
        defaultAccount: {
            sandbox: true,
    ...
    payPal: {
        ...
        ipnNotificationUrl: 'https://devactivity.globalrockstar.com',
        simple: {
