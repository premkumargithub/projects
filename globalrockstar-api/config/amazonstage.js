module.exports = {
    ...
    db: 'mongodb://172.16.222.60/global-rockstar',
    upload: process.env['UPLOAD'] || 'http://localhost:3043',
    agenda: {
        db: 'mongodb://172.16.222.60/global-rockstar-agenda',
        collection: 'agenda'
    },
    ...
    frontendUrl: 'https://stagebeta.globalrockstar.com',
    facebook: {
        artistUrl: 'https://stagefacebook-artist.globalrockstar.com',
        arenaUrl: 'https://stagefacebook-arena.globalrockstar.com'
    },
    payPal_sandbox: {
        defaultAccount: {
            sandbox: true,
    ...
    payPal: {
        ...
        ipnNotificationUrl: 'https://stageactivity.globalrockstar.com',
        simple: {
